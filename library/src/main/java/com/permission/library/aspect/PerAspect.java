...
import com.permission.library.PerRequester;
...
/**
 * Created by helixs on 2017/5/10.
 */
@Aspect
public class PerAspect {
    ...
    public Object requestPermissionAndExecute(final ProceedingJoinPoint joinPoint, Permissions ann) throws Throwable {
        ...
        PerRequester.getDefault()
                .targetPermissions(permission)
                .showRationale(showRationale)
                .callback(new PerCallback(args, target, joinPoint)).apply(context);
        return null;
    }
